/* server side keeps on adding value 
 * client sends value say (6,7) 
 * server adds and sends the result 13
 * */
...
#define SOCKET_NAME "/tmp/DemoSocket" //socket name 
#define BUFFER_SIZE 128 

int
main(int argc, char *argv[])
{
    struct sockaddr_un name;//provided by std C api defenation as below
    
#if 0  
    struct sockaddr_un {
        sa_family_t sun_family;               /* AddressFamily_UNIX always constant value defined by Cstd libraries "AF_UNIX"*/
